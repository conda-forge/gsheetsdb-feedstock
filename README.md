...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/gsheetsdb-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8963&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/gsheetsdb-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `gsheetsdb` can be installed with:

```
conda install gsheetsdb
```

It is possible to list all of the versions of `gsheetsdb` available on your platform with:
